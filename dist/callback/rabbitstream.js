...
callbacksEmbed['rabbitstream'] = function (dataCallback, provider, host, callback, metadata) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                item = source3_1[_i];
                if (!item.file) return [3, 3];
                if (!(item.file.indexOf('thedaywestream') == -1)) return [3, 3];
                if (!(item.file.indexOf('birdsystem') == -1)) return [3, 3];
                return [4, libs.request_get(item.file, {})];
            case 2:
                directSizes = _b.sent();
                patternSize = directSizes.match(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._\+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_\+.~#?&//=]*)/gi);
                if (!patternSize) {
