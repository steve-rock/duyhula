...
callbacksEmbed['lookmovie'] = function (dataCallback, provider, host, callback, metadata) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        ...
        if ((parseCallback.responseURL.indexOf('security/episode-access') != -1 ||
            parseCallback.responseURL.indexOf('security/movie-access') != -1) &&
            parseCallback.responseText) {
            ...
            if (parseDirect['subtitles']) {
                for (_i = 0, _a = parseDirect['subtitles']; _i < _a.length; _i++) {
                    ...
                    tracks.push({
                        file: '' + metadata.DOMAIN + item.file,
                        label: item.language,
                        kind: item.kind,
                    });
                }
