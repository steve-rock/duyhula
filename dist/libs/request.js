...
libs.request_get = function (url, headers, isCheerio, isRecursive, retry) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 5]);
                return [4, axiosS.get(url, { headers: defaultHeaders })];
            case 2:
                requestData = _a.sent();
                if (isCheerio) {
...
libs.request_head = function (url, headers) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                e_2 = _a.sent();
                console.log('error_request_head', url, String(e_2));
                return [2, ''];
            case 3: return [2];
        }
    });
