...
source.getResource = function (movieInfo, config, callback) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_f.label) {
            case 0:
                ...
                ji = function (t, n) {
                    ...
                    for (s = 0; s < f; s += 1) {
                        (e = (e + o[s] + t.charCodeAt(s % t.length)) % f), (u = o[s]), (o[s] = o[e]), (o[e] = u);
                    }
                ...
                li = function (t) {
                    ...
                    for (var n = '', r = -1 * 5867 + -2617 + 202 * 42; r < t.length; r += -1546 + 7 * -577 + 5588) {
                        var i = [
                            void (-1371 + 6543 * 1 + -5172),
                            void (1 * -2512 + -2 * -4171 + -2915 * 2),
                            void (-1367 * 2 + 3086 + -32 * 11),
                            void (-1319 * 1 + -4022 + -109 * -49),
                        ];
                        (i[-6509 * -1 + 1126 + -509 * 15] = t.charCodeAt(r) >> (-1217 * -6 + -4230 + -3070)),
                            (i[-4994 + 1732 + 251 * 13] =
                                ((7704 + 974 + -8675) & t.charCodeAt(r)) << (-26 * 262 + 7502 + -1 * 686)),
                            t.length > r + (-2857 * 1 + 1 * 9328 + 5 * -1294) &&
                                ((i[6645 + 1 * -4421 + -2223] |=
                                    t.charCodeAt(r + (-80 * -78 + 1129 * -7 + 1664)) >> (-470 * 17 + 7 * -1023 + 15155)),
                                    (i[1 * 7066 + 707 * 1 + -7771] =
                                        ((-1 * -3449 + -8851 + 1 * 5417) & t.charCodeAt(r + (34 * 21 + 3831 + -71 * 64))) <<
                                            (16 * -93 + 2 * -4216 + 11 * 902))),
                            t.length > r + (-44 * -130 + 2777 + -8495) &&
                                ((i[3 * -87 + 4192 + -3929] |=
                                    t.charCodeAt(r + (656 + -11 * -738 + -8772)) >> (5616 + -583 * -8 + 5137 * -2)),
                                    (i[-3562 + -1 * 6866 + 171 * 61] =
                                        (2604 + 1967 + -4508) & t.charCodeAt(r + (-3066 + -138 * -33 + 1 * -1486))));
                ...
                a = {
                    hn: function (t) {
                        ...
                        return decodeURIComponent(a['Mi'](r, a['mi'](n)));
                    },
                    Mi: function (t, n) {
                    ...
                    mi: function (t) {
                        ...
                        for (var r, i = '', u = 2595 + -9382 + 6787, o = -5580 + -61 * 121 + 997 * 13, e = -721 * -5 + 3058 * -2 + -27 * -93; e < t['length']; e++)
                            (u <<= 3925 + 1 * 2687 + -6606),
                                (u |=
                                    ((r = t[e]),
                                        (r = tt['indexOf'](r)) < 1660 * 1 + 1 * 667 + -2327 * 1
                                            ? void (3330 + -2169 * -1 + -5499)
                                            : r)),
                                6233 + 53 * 169 + 2 * -7583 === (o += 5312 + -60 * -22 + 3313 * -2) &&
                                    ((i += String['fromCharCode'](((21063954 + 15270719 + 1509461 * -13) & u) >> (521 + -8 * 1016 + 21 * 363))),
                                        (i += String['fromCharCode'](a['Fwmui']((-46798 * -1 + 666 * -137 + -4 * -27431) & u, -4184 + -6832 + 11024))),
                                        (i += String['fromCharCode']((-11 * -668 + 37 * -53 + 2566 * -2) & u)),
                                        (u = o = -5598 * 1 + -18 * -516 + -3690));
                        return (-611 * 7 + 2930 + 1359 === o
                            ? ((u >>= -427 * 7 + -4773 + 7766), (i += String['fromCharCode'](u)))
                            : -1099 + 6060 + -4943 === o &&
                                ((u >>= 197 * -17 + 17 * -157 + 6020),
                                    (i += String['fromCharCode'](a['Fwmui']((-123223 + -91331 * -1 + 97172) & u, 1013 * -9 + -1536 + 10661))),
                                    (i += String['fromCharCode']((9907 * -1 + 5414 + 4748) & u))),
                            i);
                    },
                    Fwmui: function (t, n) {
                        return t >> n;
                ...
                urlSearch = DOMAIN +
                    ...
                    gen(movieInfo.title) +
                    '&keyword=' +
                    movieInfo.title.trim().replace(/ /g, '+');
            ...
            case 22:
                ...
                if (!tvInfo.html) return [3, 28];
                parseTvInfo_1 = cheerio.load(tvInfo.html);
                libs.log({
                    length: parseTvInfo_1('a[data-kname="' + movieInfo.season + '-' + movieInfo.episode + '"]')
                        .length,
                }, PROVIDER, 'SEARCH TV');
                embedTokens_1 = {};
