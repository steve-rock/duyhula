...
hosts['mcloud'] = function (url, movieInfo, provider, config, callback) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                return [4, libs.request_head(url, { referer: url, 'user-agent': userAgent })];
            case 1:
                headerEmbed = _c.sent();
                cookies = '';
